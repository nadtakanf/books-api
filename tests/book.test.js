  ...
  await ddb
    .put({
      ...
      Item: {
        ISBN: "123445671",
        title:
          "Quiet: The Power of Introverts in a World That Can not Stop Talking",
        authors: [
          {
            name: "Susan Cain",
            birthday: "08/24/1890",
...
it("should update item into table", async () => {
  ...
  const result = await ddb.update({
    ...
    UpdateExpression:
      "SET title = :title, publisher = :publisher, publicationYear = :publicationYear, description =:description",
